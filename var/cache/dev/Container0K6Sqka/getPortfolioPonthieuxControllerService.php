 ...
 */
class getPortfolioPonthieuxControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\PortfolioPonthieuxController' shared autowired service.
     *
     * @return \App\Controller\PortfolioPonthieuxController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/PortfolioPonthieuxController.php';

        $container->services['App\\Controller\\PortfolioPonthieuxController'] = $instance = new \App\Controller\PortfolioPonthieuxController();
        ...
        ]))->withContext('App\\Controller\\PortfolioPonthieuxController', $container));
